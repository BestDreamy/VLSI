...
create_placement_blockage -coordinate {{   14.8 121.8} {140.225 314.1}} -name placement_blockage_1 -type soft
create_placement_blockage -coordinate {{159.735 121.8} { 285.16 314.1}} -name placement_blockage_2 -type soft
create_placement_blockage -coordinate {{   14.8  14.2} {140.225 106.4}} -name placement_blockage_3 -type soft
create_placement_blockage -coordinate {{159.735  14.2} { 285.16 106.4}} -name placement_blockage_4 -type soft
